...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -.62; // X is the up and down direction
    public static double PARALLEL_Y = -4.8; // Y is the strafe direction

    public static double PERPENDICULAR_X = 2.28;
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDriveOdo drive) {
        super(Arrays.asList(
